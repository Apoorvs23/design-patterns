package org.apoorv.builderpattern;
...
public class Main {
    public static void main(String[] args) {
        // StudentBuilder is a static nested class, so it must be accessed via Student.StudentBuilder
        Student.StudentBuilder builder = new Student.StudentBuilder("Apoorv", 10);
